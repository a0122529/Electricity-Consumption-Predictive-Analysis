			...
			<div class="navbar-default sidebar" role="navigation">
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu">
						...
						<li><a href="peakTimeLoad"><i
								class="fa fa-bar-chart-o fa-fw"></i> Peak Time Load<span
								class="fa arrow"></span></a></li>
						<li><a href="voltageFluctuations"><i
								class="fa fa-bar-chart-o fa-fw"></i> Voltage Fluctuations<span
								class="fa arrow"></span></a></li>
			...
			<div class="row">
				<div class="col-lg-8">
					<div class="panel panel-default">
						...
						<!-- /.panel-heading -->
						<div>
							<a href="https://plot.ly/~kshitijkaushik14/92/" target="_blank"
								title="Data Consumption comparison next day"
								style="display: block; text-align: center;"><img
								src="https://plot.ly/~kshitijkaushik14/92.png"
								alt="Data Consumption comparison next day"
								style="max-width: 100%; width: 792px;" width="792"
								onerror="this.onerror=null;this.src='https://plot.ly/404.png';" /></a>
							<script data-plotly="kshitijkaushik14:92"
									...
									<div class="table-responsive">
										<table class="table table-bordered table-hover table-striped">
											<thead>
												<tr>
													<th>Date</th>
													<th>Next day Prediction(kW)</th>
												</tr>
											</thead>
											<tbody>
												<c:forEach var="val" items="${ndc}">
													<tr>
														<td>11/27/2012</td>
														<td><c:out value="${ndc.get(0)}" /></td>
														<%--  </c:forEach> --%>
													</tr>
												</c:forEach>
