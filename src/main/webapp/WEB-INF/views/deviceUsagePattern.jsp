...
<title>Device Usage Pattern</title>
	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-static-top" role="navigation"
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.html">Device Usage Pattern
					Computation</a>
			</div>
			<!-- /.navbar-header -->
		...
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">Device Usage Pattern </h1>
				</div>
				<!-- /.col-lg-12 -->
			</div>
			<!-- /.row -->
			...
			<div class="row">
				<div class="col-lg-8">
					<div class="panel panel-default">
						<div class="panel-heading">
							<i class="fa fa-bar-chart-o fa-fw"></i> Device Usage Pattern Plot
						...
						<!-- /.panel-heading -->
						<div>
							<a href="https://plot.ly/~kshitijkaushik14/95/" target="_blank"
								title="Power utilization comparison for different areas in house"
								style="display: block; text-align: center;"><img
								src="https://plot.ly/~kshitijkaushik14/95.png"
								alt="Power utilization comparison for different areas in house"
								style="max-width: 100%; width: 792px;" width="792"
								onerror="this.onerror=null;this.src='https://plot.ly/404.png';" /></a>
							<script data-plotly="kshitijkaushik14:95"
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<i class="fa fa-bar-chart-o fa-fw"></i> Device Usage Data Computation
								...
								<div class="col-lg-10" style="padding-left: 100px">
									<div class="table-responsive">
										<table class="table table-bordered table-hover table-striped">
											...
											<tbody>
											<tbody>
												<c:forEach var="val" items="${dup}">
													<tr>
														<td><c:out value="${val.value.get(0)}" /></td>
														<td><c:out value="${val.value.get(5)}" /></td>

														<td><c:out value="${val.value.get(6)}" /></td>
														<td><c:out value="${val.value.get(7)}" /></td>
														<%--  </c:forEach> --%>
													</tr>
												</c:forEach>
