...
<title>Peak Time Load for Weekends per month</title>
	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-static-top" role="navigation"
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.html">Total Peak
					Time(7am-11am) Load in Weekends for 1 month</a>
			</div>
			<!-- /.navbar-header -->
			...
			<div class="navbar-default sidebar" role="navigation">
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu">
						...
						<li><a href="#"><i class="fa fa-bar-chart-o fa-fw"></i>
								Weekday and Weekend Pattern<span class="fa arrow"></span></a>
							<ul class="nav nav-second-level">
		...
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">WeekDay Peak Load Value</h1>
				</div>
				<!-- /.col-lg-12 -->
			</div>
			<!-- /.row -->
			...
			<div class="row">
				<div class="col-lg-8">
					<div class="panel panel-default">
						<div class="panel-heading">
							<i class="fa fa-bar-chart-o fa-fw"></i> Weekday and Weekend Power
							Consumption change
						...
						<!-- /.panel-heading -->
						<div>
							<a href="https://plot.ly/~kshitijkaushik14/86/" target="_blank"
								title="Weekdays and Weekends power comparison(7am-11am) Line Chart"
								style="display: block; text-align: center;"><img
								src="https://plot.ly/~kshitijkaushik14/86.png"
								alt="Weekdays and Weekends power comparison(7am-11am) Line Chart"
								style="max-width: 100%; width: 792px;" width="792"
								onerror="this.onerror=null;this.src='https://plot.ly/404.png';" /></a>
							<script data-plotly="kshitijkaushik14:86"
								src="https://plot.ly/embed.js" async></script>
						</div>

						<div>
							<a href="https://plot.ly/~kshitijkaushik14/89/" target="_blank"
								title="Weekdays and Weekends power comparison(7am-11am) Bar Chart"
								style="display: block; text-align: center;"><img
								src="https://plot.ly/~kshitijkaushik14/89.png"
								alt="Weekdays and Weekends power comparison(7am-11am) Bar Chart"
								style="max-width: 100%; width: 792px;" width="792"
								onerror="this.onerror=null;this.src='https://plot.ly/404.png';" /></a>
							<script data-plotly="kshitijkaushik14:89"
								src="https://plot.ly/embed.js" async></script>
						</div>
								...
								<div class="col-lg-10" style="padding-left: 100px">
									<div class="table-responsive">
										<table class="table table-bordered table-hover table-striped">
											...
											<tbody>
												<c:forEach var="val" items="${weekday}">
													<tr>
														<td>Mon-Fri</td>
														<td>7am - 11am</td>
														<td>1 month</td>
														<td><c:out value="${weekday.get(0)}" /></td>
														<%--  </c:forEach> --%>
													</tr>
												</c:forEach>
