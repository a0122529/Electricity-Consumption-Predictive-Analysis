			...
			<div class="row">
				<div class="col-lg-8">
					<div class="panel panel-default">
						<div class="panel-heading">
							<i class="fa fa-bar-chart-o fa-fw"></i> Year 2013 Prediction Plot
						...
						<div>
							<a href="https://plot.ly/~kshitijkaushik14/210/" target="_blank"
								title="Year 2013 power utilization "
								style="display: block; text-align: center;"><img
								src="https://plot.ly/~kshitijkaushik14/210.png"
								alt="Year 2013 power utilization "
								style="max-width: 100%; width: 792px;" width="792"
								onerror="this.onerror=null;this.src='https://plot.ly/404.png';" /></a>
							<script data-plotly="kshitijkaushik14:210"
								...
								<div class="col-lg-10" style="padding-left: 100px">
									<div class="table-responsive">
										<table class="table table-bordered table-hover table-striped">
											...
											<tbody>
												<c:forEach var="val" items="${finalPrediction2013}">
													<tr>
