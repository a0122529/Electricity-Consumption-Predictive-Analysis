...
<title>Revenue Loss Prediction for Power Company</title>
	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-static-top" role="navigation"
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.html">Revenue Loss
					Prediction for Power Company</a>
			</div>
			<!-- /.navbar-header -->
		...
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">Revenue Loss Prediction</h1>
				</div>
				<!-- /.col-lg-12 -->
			</div>
			<!-- /.row -->
			...
			<div class="row">
				<div class="col-lg-8">
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<i class="fa fa-bar-chart-o fa-fw"></i> Revenue Loss Prediction
							Data
							<div class="pull-right">
								<div class="btn-group">
									<button type="button"
										...
										<table class="table table-bordered table-hover table-striped">
											<thead>
												<tr>
													...
													<th>Revenue Loss for Company per house(cents/day)</th>
												</tr>
											</thead>
											<tbody>
												<c:forEach var="val" items="${rl}">
													<tr>
														<td>1</td>
														<td><c:out value="${rl.get(0)}" /></td>
														<%--  </c:forEach> --%>
													</tr>
												</c:forEach>
