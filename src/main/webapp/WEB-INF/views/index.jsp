...
<title>Energy Consumption and Prediction</title>
	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-static-top" role="navigation"
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.html">April Prediction </a>
			</div>
			<!-- /.navbar-header -->
			...
			<div class="navbar-default sidebar" role="navigation">
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu">
						...
						<li><a href="predctn2013"><i
								class="fa fa-bar-chart-o fa-fw"></i> Year 2013<span
		...
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">Energy Consumption Analysis and
						Prediction</h1>
				</div>
				<!-- /.col-lg-12 -->
			</div>
			...
			<div class="row">
				<div class="col-lg-8">
					<div class="panel panel-default">
						<div class="panel-heading">
							<i class="fa fa-bar-chart-o fa-fw"></i> Year 2012 Prediction Plot
						...
						<div>
							<a href="https://plot.ly/~kshitijkaushik14/108/" target="_blank"
								title="Power Consumption 2012(nov -dec) in kW"
								style="display: block; text-align: center;"><img
								src="https://plot.ly/~kshitijkaushik14/108.png"
								alt="Power Consumption 2012(nov -dec) in kW"
								style="max-width: 100%; width: 792px;" width="792"
								onerror="this.onerror=null;this.src='https://plot.ly/404.png';" /></a>
							<script data-plotly="kshitijkaushik14:108"
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<i class="fa fa-bar-chart-o fa-fw"></i> Power Consumption
							Prediction in 2012
										...
										<table class="table table-bordered table-hover table-striped">
											<thead>
												<tr>
													<th>Date</th>
													<th>Day</th>
													<th>Predicted power utilization(kW)</th>

												</tr>
											</thead>
											<tbody>
												<c:forEach var="val" items="${finalPrediction2012}">
													<tr>
