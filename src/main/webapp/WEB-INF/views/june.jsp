	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-static-top" role="navigation"
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.html">June Prediction </a>
			</div>
			<!-- /.navbar-header -->
		...
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">June Prediction</h1>
				</div>
				<!-- /.col-lg-12 -->
			</div>
			<!-- /.row -->
			...
			<div class="row">
				<div class="col-lg-8">
					<div class="panel panel-default">
						<div class="panel-heading">
							<i class="fa fa-bar-chart-o fa-fw"></i> June Consumption Plot
						...
						<div>
							<a href="https://plot.ly/~kshitijkaushik14/181/" target="_blank"
								title="power utilization for june 2013"
								style="display: block; text-align: center;"><img
								src="https://plot.ly/~kshitijkaushik14/181.png"
								alt="power utilization for june 2013"
								style="max-width: 100%; width: 792px;" width="792"
								onerror="this.onerror=null;this.src='https://plot.ly/404.png';" /></a>
							<script data-plotly="kshitijkaushik14:181"
